...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <div className={`fixed inset-y-0 right-0 z-50 w-64 bg-white border-l border-gray-200 min-h-screen flex flex-col justify-between transform transition-transform ${isSidebarOpen ? 'translate-x-0' : 'translate-x-full'} md:relative md:translate-x-0 overflow-y-auto`}>
